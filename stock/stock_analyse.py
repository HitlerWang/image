...
if __name__ == '__main__':
    # analyse_gg_list(["603233"],"2019-12-31", "2020-02-26")


    # analyse_gg_list(["600489","601766","600398"],"2019-12-31", "2020-02-26")
    # print("\n")
    # analyse_gg_list(["600871","600968","601808","600583"],"2019-12-31", "2020-02-26")
    # print("\n")
    # analyse_hq()
    # analyse_gg_xuangu_all("2020-02-26", "2020-02-26" , "2019-12-31", "2020-02-26" )

    for item in ["02","03","06","07","08","09","10","13","14","15","16","17","20","21","22","23"]:
        agg_partition_stock_all("2020-01-"+ item)
